...
| [ADR-0003](ADR-0003-domain-contracts-and-schema-authority.md) | Proposed | Domain contracts and JSON Schema authority          |
| [ADR-0004](ADR-0004-runtime-state-machine-and-concurrency.md) | Proposed | Runtime lifecycle, leases, fencing, and concurrency |
